...
return [
    ...
    'min_length'            => 'Le champ {field} doit avoir au moins {param} caractères.',
    ...
    'regex_match'           => 'Le champ {field} n\'est pas au format correct.',
    ...
    /* Credit Cards */
    'valid_cc_number' => 'Le champ {field} ne semble pas être un numéro de carte de crédit valide.',

    /* Files */
    'uploaded' => 'Le champ {field} n\'est pas un fichier chargé valide.',
    'max_size' => 'Le fichier du champ {field} est trop volumineux.',
    'is_image' => 'Le champ {field} n\'est pas une image chargée valide.',
    'mime_in'  => 'Le champ {field} n\'a pas un type MIME valide.',
    'ext_in'   => 'Le champ {field} n\'a pas une extension de fichier valide.',
    'max_dims' => 'Le champ {field} n\'est pas une image, ou elle est trop large ou trop haute.',
    'min_dims' => 'Le champ {field} n\'est pas une image, ou elle n\'est pas assez large ou haute.',
];
