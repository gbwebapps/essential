...
return [
    ...
    'messages' => [
        ...
        'wrongColumnsNumber' => "Riga %d: formato riga del CSV malformato (%d colonne trovate, l'intestazione ne dichiara %d).",
        'fileNotFoundError' => 'Non è stato trovato il file. Probabilmente è stato rimosso.', 
        'notDeterminedPrimaryKey' => "Impossibile determinare la Primary Key per l'entità %s.", 
        ...
        'insufficientColumns' => 'Il CSV deve contenere almeno 2 colonne.', 
        'missingPrimaryKey' => 'La colonna %s è obbligatoria.', 
        'invalidColumns' => 'Le seguenti colonne non sono valide: %s', 
    ],
];
