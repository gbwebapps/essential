...
/**
 * Componente di logica applicativa dedicato alla gestione e configurazione della logs di backend.
 *
...
{
	/**
	 * Modello di persistenza dedicato all'estrazione delle metriche e dei dati aggregati per la logs.
	 *
	 * @var LogsModel
	 */
	 ...
	 *
	 * @param LogsModel $logsModel Istanza del modello per le query analitiche sul database.
	 */
	...
	/**
	 * Genera l'elenco delle opzioni contestuali e dei filtri rapidi per la schermata principale della logs.
	 *
	...
	// 	return 
	// 	[
	// 	    ['label' => lang('backend/logs.options.first'),  'route' => '#', 'icon' => '', 'class' => '', 'id' => ''],
	// 	    ['label' => lang('backend/logs.options.second'), 'route' => '#', 'icon' => '', 'class' => '', 'id' => ''],
	// 	    ['label' => lang('backend/logs.options.thirst'),  'route' => '#', 'icon' => '', 'class' => '', 'id' => ''],
	// 	];
	// }
	...
	/**
	 * Costruisce la barra di navigazione secondaria per la sezione index della logs.
	 *
	...
	/*public function getLinksBarIndex()
	{
		return 
		[
            ['icon' => '<i class="fa-solid fa-tachometer"></i>', 'label' => lang('backend/logs.options.performances'), 'route' => 'backend/logs'],
        ];
	}*/
	...
	/**
	 * Restituisce l'elenco dei file JavaScript specifici richiesti per il corretto funzionamento della logs.
	 *
	...
	/**
	 * Restituisce l'elenco dei fogli di stile CSS specifici per l'interfaccia della logs.
	 *
