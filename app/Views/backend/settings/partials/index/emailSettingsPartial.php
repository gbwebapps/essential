<div class="card-body">
    ...
    <form id="email-settings" autocomplete="off" novalidate>
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_fromEmail" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.fromEmail'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_fromName" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.fromName'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_recipients" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.recipients'); ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="email_protocol" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.protocol'); ?></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="email_SMTPHost" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPHost'); ?></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="email_SMTPPort" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPPort'); ?></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="email_SMTPCrypto" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPCrypto'); ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_SMTPUser" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPUser'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_SMTPPass" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPPass'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_SMTPAuthMethod" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.SMTPAuthMethod'); ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_mailType" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.mailType'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_charset" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.charset'); ?></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="email_priority" class="form-label  mb-1"><i class="fa-solid fa-circle-arrow-down"></i> <?= lang('backend/settings.labels.priority'); ?></label>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-center gap-2">
                            ...
                            <button type="button" class="btn btn-danger btn-sm btn-delete-email" data-message="<?= lang('backend/settings.messages.areYouSureDeleteSettings'); ?>">
                                <i class="fa-solid fa-trash-can me-1"></i><?= lang('backend/settings.buttons.restoreData'); ?>
                            </button>
                            
                            <button type="button" class="btn btn-warning btn-sm text-dark btn-refresh-email" data-message="<?= lang('backend/settings.messages.areYouSureRefreshSettings'); ?>">
