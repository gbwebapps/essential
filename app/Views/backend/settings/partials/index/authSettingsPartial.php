        ...
        <div class="row">
            ...
            <div class="col-12 mb-4">
                <div class="row g-0 bg-light pt-2 ps-2 pe-2 border rounded-2">
                    <div class="col-12 text-start">
                        <h5><i class="fa-solid fa-shield-halved"></i><?= lang('backend/settings.labels.security'); ?></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <select id="auth_twoFactorDigits" name="twoFactorDigits" class="form-select shadow-none">
                    <option value="6" <?= (int)$authSettings['twoFactorDigits'] === 6 ? 'selected' : ''; ?>>6</option>
                    <option value="8" <?= (int)$authSettings['twoFactorDigits'] === 8 ? 'selected' : ''; ?>>8</option>
                </select>
            ...
            <div class="col-12 mt-4 text-center">
                <button type="button" class="btn btn-outline-danger btn-sm btn-delete-auth" data-message="Sei sicuro di voler ripristinare i valori dei files?">
                    <i class="fa-solid fa-trash-can me-1"></i><?= lang('backend/settings.buttons.restoreData'); ?>
                </button>
                <button type="button" class="btn btn-danger btn-sm text-white me-2 btn-refresh-auth">
